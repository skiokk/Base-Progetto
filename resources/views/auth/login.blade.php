            ...
            <form action="{{ route('login.post') }}" method="POST" autocomplete="off" novalidate>
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="La tua password" autocomplete="off" />
                  <span class="input-group-text">
                    <a href="#" class="link-secondary" title="Mostra password" data-bs-toggle="tooltip">
